...
export async function updateSupabaseSession(request: NextRequest) {
  ...
  const isPublic = pathname === "/login" || pathname === "/api/auth/signup" || pathname.startsWith("/auth") || pathname.startsWith("/api/webhooks/") || pathname.startsWith("/api/jobs/") || pathname.startsWith("/_next") || pathname.includes(".");
