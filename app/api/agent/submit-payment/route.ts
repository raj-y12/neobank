...
export async function POST(request: Request) {
  try {
    ...
    const payment = createPayment({ businessId: context.businessId, accountId: context.accountId, initiatorId: `agent:${context.memberId}`, amountCents: body.amountCents, currency: "USD", rail: "ACH", recipient: body.recipient });
